...
var (
	...
	minusOneNumber = Number("-1")
	minusOneTerm   = &Term{Value: minusOneNumber}
)

func CachedBooleanTerm(b bool) *Term {
	if b {
...
// CachedIntNumberTerm returns a term with the given integer value. The term is
// cached between -1 to 512, and for values outside of that range, this function
// is equivalent to ast.IntNumberTerm.
func CachedIntNumberTerm(i int) *Term {
	...
	return &Term{Value: Number(i)}
}

func HasCachedIntNumberTerm(i int) bool {
