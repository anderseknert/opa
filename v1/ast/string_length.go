...
func (s *set) StringLength() int {
	...
	// surrounding braces + ", " for every element - 1
	return TermSliceStringLength(s.Slice(), 2) + 2
}

func (a *Array) StringLength() (n int) {
	if a.Len() == 0 {
		return 2 // []
	}
...
func (c Call) StringLength() (n int) {
...
func (s *SetComprehension) StringLength() (n int) {
	return s.Term.StringLength() + s.Body.StringLength() + 5 // {} and " | "
}

func (a *ArrayComprehension) StringLength() (n int) {
...
func (p *Package) StringLength() (n int) {
	if p == nil {
...
func (r *Rule) StringLength() (n int) {
...
func (h *Head) StringLength() (n int) {
...
func (e *Expr) StringLength() (n int) {
	...
	default:
		panic(fmt.Sprintf("rego string length not implemented for type: %T", e.Terms))
	}
